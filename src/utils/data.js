...
export const locales = [{
  code: "aa_DJ",
  label: "Afar (Ddjibouti)",
  value: "Afar (Ddjibouti)"
}, {
  code: "aa_ER",
  label: "Afar (Eritrea)",
  value: "Afar (Eritrea)"
  ...
  code: "an_ES",
  label: "Aragonese (Spain)",
  value: "Aragonese (Spain)"
}, {
  code: "ar",
  label: "Arabic",
  value: "Arabic"
  ...
  code: "bho_IN",
  label: "Bhojpuri (India)",
  value: "Bhojpuri (India)"
}, {
  code: "bm",
  label: "Bambara",
  value: "Bambara"
  ...
  code: "crh_UA",
  label: "Crimean Tatar (Ukraine)",
  value: "Crimean Tatar (Ukraine)"
}, {
  code: "cs",
  label: "Czech",
  value: "Czech"
  ...
  code: "csb_PL",
  label: "Kashubian (Poland)",
  value: "Kashubian (Poland)"
}, {
  code: "cv_RU",
  label: "Chuvash (Russia)",
  value: "Chuvash (Russia)"
}, {
  code: "cy",
  label: "Welsh",
  value: "Welsh"
  ...
  code: "dv_MV",
  label: "Dhivehi (Maldives)",
  value: "Dhivehi (Maldives)"
}, {
  code: "dz_BT",
  label: "Dzongkha (Buthan)",
  value: "Dzongkha (Buthan)"
}, {
  code: "ebu",
  label: "Embu",
  value: "Embu"
  ...
  value: "Friulian (Italy)"
}, {
  code: "fy_DE",
  label: "Western Frisian (Germany)",
  value: "Western Frisian (Germany)"
}, {
  code: "fy_NL",
  label: "Western Frisian (Netherlands)",
  value: "Western Frisian (Netherlands)"
}, {
  code: "ga",
  label: "Irish",
  value: "Irish"
  ...
  value: "Scottish Gaelic (United Kingdom)"
}, {
  code: "gez_ER",
  label: "Geez (Eritrea)",
  value: "Geez (Eritrea)"
  ...
  code: "ik_CA",
  label: "Inupiaq (Canada)",
  value: "Inupiaq (Canada)"
}, {
  code: "is",
  label: "Icelandic",
  value: "Icelandic"
  ...
  value: "Luxembourgish (Luxembourg)"
}, {
  code: "lg",
  label: "Ganda",
  value: "Ganda"
  ...
  code: "li_BE",
  label: "Limburgan (Belgium)",
  value: "Limburgan (Belgium)"
}, {
  code: "li_NL",
  label: "Limburgan (Netherlands)",
  value: "Limburgan (Netherlands)"
}, {
  code: "lij_IT",
  label: "Ligurian (Italy)",
  value: "Ligurian (Italy)"
}, {
  code: "lo_LA",
  label: "Lao (Laos)",
  value: "Lao (Laos)"
  ...
  code: "mai_IN",
  label: "Maithili (India)",
  value: "Maithili (India)"
}, {
  code: "mas",
  label: "Masai",
  value: "Masai"
  ...
  code: "mhr_RU",
  label: "Eastern Mari (Russia)",
  value: "Eastern Mari (Russia)"
}, {
  code: "mi_NZ",
  label: "Maori (New Zealand)",
  value: "Maori (New Zealand)"
}, {
  code: "mk",
  label: "Macedonian",
  value: "Macedonian"
  ...
  code: "nds_DE",
  label: "Low German (German)",
  value: "Low German (German)"
}, {
  code: "nds_NL",
  label: "Low German (Netherlands)",
  value: "Low German (Netherlands)"
}, {
  code: "ne",
  label: "Nepali",
  value: "Nepali"
  ...
  value: "South Ndebele (South Africa)"
}, {
  code: "nso_ZA",
  label: "Pedi (South Africa)",
  value: "Pedi (South Africa)"
}, {
  code: "nyn",
  label: "Nyankole",
  value: "Nyankole"
  ...
  code: "os_RU",
  label: "Ossetian (Russia)",
  value: "Ossetian (Russia)"
}, {
  code: "pa",
  label: "Punjabi",
  value: "Punjabi"
  ...
  code: "pa_PK",
  label: "Panjabi (Pakistan)",
  value: "Panjabi (Pakistan)"
}, {
  code: "pap_AN",
  label: "Papiamento (Netherlands)",
  value: "Papiamento (Netherlands)"
}, {
  code: "pl",
  label: "Polish",
  value: "Polish"
  ...
  code: "sc_IT",
  label: "Sardinian (Italy)",
  value: "Sardinian (Italy)"
}, {
  code: "sd_IN",
  label: "Sindhi (India)",
  value: "Sindhi (India)"
  ...
  code: "shs_CA",
  label: "Shuswap (Canada)",
  value: "Shuswap (Canada)"
}, {
  code: "si",
  label: "Sinhala",
  value: "Sinhala"
  ...
  value: "Swati (South Africa)"
}, {
  code: "st_ZA",
  label: "Southern Sotho (South Africa)",
  value: "Southern Sotho (South Africa)"
}, {
  code: "sv",
  label: "Swedish",
  value: "Swedish"
  ...
  value: "Uzbek (Uzbekistan)"
}, {
  code: "ve_ZA",
  label: "Venda (South Africa)",
  value: "Venda (South Africa)"
}, {
  code: "vi",
  label: "Vietnamese",
  value: "Vietnamese"
  ...
  code: "wa_BE",
  label: "Walloon (Belgium)",
  value: "Walloon (Belgium)"
}, {
  code: "wae_CH",
  label: "Walser (Switzerland)",
  value: "Walser (Switzerland)"
}, {
  code: "wal_ET",
  label: "Wolaytta (Ethiopia)",
  value: "Wolaytta (Ethiopia)"
}, {
  code: "wo_SN",
  label: "Wolof (Senegal)",
  value: "Wolof (Senegal)"
  ...
  code: "yi_US",
  label: "Yiddish (America)",
  value: "Yiddish (America)"
}, {
  code: "yo",
  label: "Yoruba",
  value: "Yoruba"
  ...
  code: "yue_HK",
  label: "Yue Chinese (China)",
  value: "Yue Chinese (China)"
}, {
  code: "zh",
  label: "Chinese",
  value: "Chinese"
